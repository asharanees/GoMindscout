      ...
      <div className="max-w-3xl mx-auto px-4 py-16 w-full flex-1">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">GoMindscout is a marketplace that facilitates connections between mentees seeking professional guidance and mentors offering expertise. GoMindscout is not a party to any mentoring relationship and does not employ mentors. Mentors are independent contractors.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">Mentors agree to provide professional, honest guidance; respond to bookings within 24 hours; and maintain the qualifications and expertise represented in their profile. GoMindscout reserves the right to remove any mentor from the platform for violating these obligations.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">6. Prohibited Conduct</h2>
            <p className="text-muted-foreground leading-relaxed">Users may not use GoMindscout to provide illegal advice, engage in discrimination, solicit personal contact outside the platform to avoid fees, misrepresent credentials, or engage in any activity that harms other users or GoMindscout.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">7. Limitation of Liability</h2>
            <p className="text-muted-foreground leading-relaxed">GoMindscout is not liable for the content of any mentoring session or for any outcomes resulting from mentoring advice. We do not guarantee that any mentor is licensed, certified, or qualified to provide specific professional advice including legal, financial, or medical guidance.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">8. Contact</h2>
            <p className="text-muted-foreground leading-relaxed">Questions about these Terms should be directed to our contact page or emailed to support@gomindscout.com.</p>
          </section>
        </div>
      </div>
      <Footer />
