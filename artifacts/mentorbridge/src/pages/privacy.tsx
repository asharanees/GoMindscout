      ...
      <div className="max-w-3xl mx-auto px-4 py-16 w-full flex-1">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">You have the right to access, correct, or delete your personal data. You can update your account information at any time. To request data deletion, contact us at privacy@mentorbridge.com.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">Privacy questions can be directed to privacy@mentorbridge.com or through our contact page.</p>
          </section>
        </div>
      </div>
      <Footer />
