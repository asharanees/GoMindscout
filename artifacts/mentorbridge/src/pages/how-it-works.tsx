        ...
        <div className="space-y-16">
          {[
            ...
            },
            {
              ...
              desc: "Once your mentor confirms a time, the platform automatically generates a private video meeting room and emails the link to both of you. Just click and join - no downloads or setup required.",
              points: ["Private video room auto-generated by the platform", "Meeting link sent by email to both parties", "Join from any browser, no app required", "Sessions run on time, every time"],
            },
            {
              step: "04",
