        ...
        <div className="space-y-16">
          {[
            ...
            },
            {
              ...
              points: ["30-min intro calls for quick questions", "60-min deep dives for complex challenges", "100% secure payment via Stripe"],
            },
            {
              step: "03",
              icon: <Video className="h-7 w-7 text-primary" />,
              title: "Have Your Session",
              desc: "Once your mentor confirms a time, the platform automatically generates a private video meeting room with the link shared on your dashboard and theirs. Just click and join - no downloads or setup required.",
              points: ["Private video room auto-generated by the platform", "Join from any browser, no app required", "Sessions run on time, every time"],
            },
            {
              step: "04",
